...
export default function AdminNotFound() {
  return (
    <section className="rounded-2xl bg-card p-8 text-center shadow-sm ring-1 ring-border">
      ...
      <h1 className="mt-2 font-display text-2xl font-semibold text-foreground">Admin page not found</h1>
      <p className="mt-2 text-sm text-muted">The admin page you requested is unavailable.</p>
      <Link
        href="/admin"
